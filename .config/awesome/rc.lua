...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "e", function() awful.spawn("rofimoji") end,
        { description = "launch rofimoji", group = "launcher" }),
    awful.key({ modkey }, "BackSpace", function() awful.spawn("rofi -show window") end,
    ...
    awful.key({ modkey, "Shift" }, "b", function() awful.spawn("blueman-manager") end,
        { description = "open bluetooth manager", group = "launcher" }),

    -- Audio Settings
    awful.key({ modkey, "Shift" }, "v", function() awful.spawn("pavucontrol") end,
        { description = "open pavucontrol", group = "launcher" }),
    awful.key({ modkey }, "v", function() awful.spawn("rofi -show rofi-sound -modi rofi-sound-output-chooser") end,
        { description = "rofi pick sound device", group = "launcher" }),

    -- Network
    awful.key({ modkey }, "w", function() awful.spawn("networkmanager_dmenu") end,
        { description = "rofi network menu", group = "launcher" })

-- Wallpaper Selector
-- awful.key({ modkey, "Shift" }, "w", function () awful.spawn('rofi -show wall -modi "wall:wallpaper-chooser.sh"') end,
